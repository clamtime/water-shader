...
Shader "New Amplify Shader"
{
	Properties
	{
		...
		[ASEBegin]_RockLight("Rock Light", Color) = (0.6039216,0.682353,0.5803922,1)
		...
		_TriplanarSampler("Triplanar Sampler", Float) = 0.7
		...
		_RampSmoothness("Ramp Smoothness", Range( 0 , 1)) = 0
		[ASEEnd]_RampOffset("Ramp Offset", Range( 0 , 1)) = 0
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 _RockDark;
			float4 _MossDark;
			float3 _MossTranslate2;
			float3 _MossScale2;
			float3 _MossScale;
			float3 _MossTranslate;
			float3 _MatchingNoiseScale2;
			float3 _MatchingTranslate;
			float3 _MatchingNoiseScale;
			float _MultiplyAmount;
			float _RampOffset;
			float _RampSmoothness;
			float _MossEdgeTHickness;
						 ...
						 ) : SV_Target
			{
				...
				float simplePerlin3D54 = snoise( ( _MossTranslate2 + ( _MossScale2 * WorldPosition ) ) );
				float simplePerlin3D55 = snoise( ( ( WorldPosition * _MossScale ) + _MossTranslate ) );
				float3 objToWorld49 = mul( GetObjectToWorldMatrix(), float4( float3( 0,0,0 ), 1 ) ).xyz;
				float clampResult43 = clamp( ( WorldPosition.y + -objToWorld49.y + 0.3 ) , 0.0 , 1.0 );
				...
				float dotResult2 = dot( normalizedWorldNormal , SafeNormalize(_MainLightPosition.xyz) );
				float smoothstepResult164 = smoothstep( _RampOffset , ( _RampOffset + _RampSmoothness ) , dotResult2);
				float temp_output_169_0 = saturate( ( ase_lightAtten * smoothstepResult164 ) );
				float temp_output_5_0 = ( temp_output_169_0 + ( 1.0 - dotResult2 ) );
				float4 lerpResult24 = lerp( lerpResult25 , lerpResult29 , saturate( temp_output_5_0 ));
				float3 temp_output_86_0 = ( WorldPosition + _MatchingTranslate );
				...
				float4 triplanar68 = TriplanarSampling68( _Texture0, WorldPosition, WorldNormal, 1.0, temp_cast_2, 1.0, 0 );
				float4 blendOpSrc74 = saturate( ( 1.0 - temp_output_79_0 ) );
				float4 blendOpDest74 = CalculateContrast(1.18,(float4( 0,0,0,0 ) + (triplanar68 - float4( 0,0,0,0 )) * (float4( 10,10,10,10 ) - float4( 0,0,0,0 )) / (float4( 1,1,1,1 ) - float4( 0,0,0,0 ))));
				float4 temp_output_95_0 = ( lerpResult24 * ( 1.0 - ( -temp_output_28_0 + saturate( round( ( temp_output_39_0 + ( _MossEdgeTHickness * clampResult43 ) ) ) ) ) ) * saturate( ( ( saturate( ( 1.0 - ( 1.0 - blendOpSrc74 ) * ( 1.0 - blendOpDest74 ) ) )).r + 0.0 ) ) * ( saturate( temp_output_169_0 ) + 0.0 ) );
				float4 color119 = IsGammaSpace() ? float4(0.1490196,0.2509804,0.2627451,1) : float4(0.01938236,0.05126947,0.05612849,1);
				
				float3 Albedo = ( temp_output_95_0 + ( saturate( ( 1.0 - ( temp_output_95_0 * 10.0 ) ) ) * color119 ) ).rgb;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float4 temp_output_79_0 = ( CalculateContrast(1.89,temp_cast_0) + CalculateContrast(1.71,temp_cast_1) );
				float2 temp_cast_2 = (_TriplanarSampler).xx;
				float4 triplanar68 = TriplanarSampling68( _Texture0, WorldPosition, ase_worldNormal, 1.0, temp_cast_2, 1.0, 0 );
				float4 blendOpSrc74 = saturate( ( 1.0 - temp_output_79_0 ) );
				float4 blendOpDest74 = CalculateContrast(1.18,(float4( 0,0,0,0 ) + (triplanar68 - float4( 0,0,0,0 )) * (float4( 10,10,10,10 ) - float4( 0,0,0,0 )) / (float4( 1,1,1,1 ) - float4( 0,0,0,0 ))));
				float4 temp_output_95_0 = ( lerpResult24 * ( 1.0 - ( -temp_output_28_0 + saturate( round( ( temp_output_39_0 + ( _MossEdgeTHickness * clampResult43 ) ) ) ) ) ) * saturate( ( ( saturate( ( 1.0 - ( 1.0 - blendOpSrc74 ) * ( 1.0 - blendOpDest74 ) ) )).r + 0.0 ) ) * ( saturate( temp_output_169_0 ) + 0.0 ) );
				float4 color119 = IsGammaSpace() ? float4(0.1490196,0.2509804,0.2627451,1) : float4(0.01938236,0.05126947,0.05612849,1);
...
/*ASEBEGIN
Version=18900
0;73;1920;968;3238.901;-695.2767;1;True;False
...
Node;AmplifyShaderEditor.Vector3Node;61;-4082.624,-294.9728;Inherit;False;Property;_MossScale2;Moss Scale 2;7;0;Create;True;0;0;0;False;0;False;6,6,6;0,0,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.Vector3Node;90;-2812.861,-1044.388;Inherit;False;Property;_MatchingNoiseScale;Matching Noise Scale;14;0;Create;True;0;0;0;False;0;False;1,1,1;0,0,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.RangedFloatNode;165;-3565.009,982.7557;Inherit;False;Property;_RampOffset;Ramp Offset;16;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;71;-3023.117,-875.93;Inherit;True;Property;_Texture0;Texture 0;12;0;Create;True;0;0;0;False;0;False;099ca5f9aeec7924d89ef3be794f9540;099ca5f9aeec7924d89ef3be794f9540;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.RangedFloatNode;69;-2984.325,-648.7936;Inherit;False;Property;_TriplanarSampler;Triplanar Sampler;10;0;Create;True;0;0;0;False;0;False;0.7;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;168;-3602.009,1209.756;Inherit;False;Property;_RampSmoothness;Ramp Smoothness;15;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;51;-3055.981,258.5985;Inherit;False;Property;_MultiplyAmount;Multiply Amount;5;0;Create;True;0;0;0;False;0;False;2.24;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;42;-3025.882,476.653;Inherit;False;Property;_MossEdgeTHickness;Moss Edge THickness;4;0;Create;True;0;0;0;False;0;False;0.12;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TriplanarNode;68;-2744.04,-807.9922;Inherit;True;Spherical;World;False;Top Texture 0;_TopTexture0;white;-1;None;Mid Texture 0;_MidTexture0;white;-1;None;Bot Texture 0;_BotTexture0;white;-1;None;Triplanar Sampler;Tangent;10;0;SAMPLER2D;;False;5;FLOAT;1;False;1;SAMPLER2D;;False;6;FLOAT;0;False;2;SAMPLER2D;;False;7;FLOAT;0;False;9;FLOAT3;0,0,0;False;8;FLOAT;1;False;3;FLOAT2;1,1;False;4;FLOAT;1;False;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.TFHCRemapNode;72;-2314.383,-804.6397;Inherit;False;5;0;FLOAT4;0,0,0,0;False;1;FLOAT4;0,0,0,0;False;2;FLOAT4;1,1,1,1;False;3;FLOAT4;0,0,0,0;False;4;FLOAT4;10,10,10,10;False;1;FLOAT4;0
Node;AmplifyShaderEditor.OneMinusNode;78;-1483.813,-1280.62;Inherit;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.LightAttenuation;6;-3293.286,931.2427;Inherit;False;0;1;FLOAT;0
Node;AmplifyShaderEditor.SmoothstepOpNode;164;-3069.009,1008.756;Inherit;True;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;38;-2573.882,388.653;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;77;-1299.813,-1102.62;Inherit;False;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RoundOpNode;40;-2585.882,162.653;Inherit;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleContrastOpNode;73;-2058.383,-804.6397;Inherit;True;2;1;COLOR;0,0,0,0;False;0;FLOAT;1.18;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SaturateNode;169;-2584.901,905.2767;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.BlendOpsNode;74;-1705.116,-819.93;Inherit;False;Screen;True;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;1;False;1;COLOR;0
...
Node;AmplifyShaderEditor.ColorNode;30;-1785.694,76.14667;Inherit;False;Property;_RockDark;Rock Dark;2;0;Create;True;0;0;0;False;0;False;0.4862745,0.6039216,0.6156863,1;0.6862745,0.764706,0.6980392,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;27;-1808,-160;Inherit;False;Property;_MossLight;Moss Light;1;0;Create;True;0;0;0;False;0;False;0.6039216,0.682353,0.5803922,1;0.6862745,0.764706,0.6980392,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;31;-1786.173,262.5367;Inherit;False;Property;_MossDark;Moss Dark;3;0;Create;True;0;0;0;False;0;False;0.372549,0.5019608,0.4980392,1;0.6862745,0.764706,0.6980392,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.WireNode;21;-2262.329,1403.654;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;26;-1807.521,-346.39;Inherit;False;Property;_RockLight;Rock Light;0;0;Create;True;0;0;0;False;0;False;0.6039216,0.682353,0.5803922,1;0.6862745,0.764706,0.6980392,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SaturateNode;94;-1210.382,-740.6397;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;115;-368,848;Inherit;False;Constant;_Float2;Float 2;15;0;Create;True;0;0;0;False;0;False;10;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;114;-176,736;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.ColorNode;119;-52.78558,1123.642;Inherit;False;Constant;_Color0;Color 0;15;0;Create;True;0;0;0;False;0;False;0.1490196,0.2509804,0.2627451,1;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RoundOpNode;80;-1472.813,-1380.62;Inherit;False;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;155;778.256,82.86733;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;Meta;0;4;Meta;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=Meta;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;154;778.256,82.86733;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;DepthOnly;0;3;DepthOnly;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;False;False;True;False;False;False;False;0;False;-1;False;False;False;False;False;False;False;False;False;True;1;False;-1;False;False;True;1;LightMode=DepthOnly;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;151;778.256,82.86733;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ExtraPrePass;0;0;ExtraPrePass;5;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;0;False;True;1;1;False;-1;0;False;-1;0;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;0;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;156;778.256,82.86733;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;Universal2D;0;5;Universal2D;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;0;False;True;1;1;False;-1;0;False;-1;1;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;False;False;False;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=Universal2D;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;157;778.256,82.86733;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;DepthNormals;0;6;DepthNormals;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;0;False;True;1;1;False;-1;0;False;-1;0;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;False;-1;True;3;False;-1;False;True;1;LightMode=DepthNormals;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;153;778.256,82.86733;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ShadowCaster;0;2;ShadowCaster;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;False;-1;True;3;False;-1;False;True;1;LightMode=ShadowCaster;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;158;778.256,82.86733;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;GBuffer;0;7;GBuffer;5;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;0;False;True;1;1;False;-1;0;False;-1;1;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=UniversalGBuffer;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;152;779.256,82.86733;Float;False;True;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;2;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;18;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;0;False;True;1;1;False;-1;0;False;-1;1;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=UniversalForward;False;0;Hidden/InternalErrorShader;0;0;Standard;38;Workflow;0;Surface;0;  Refraction Model;0;  Blend;0;Two Sided;1;Fragment Normal Space,InvertActionOnDeselection;0;Transmission;0;  Transmission Shadow;0.5,False,-1;Translucency;0;  Translucency Strength;1,False,-1;  Normal Distortion;0.5,False,-1;  Scattering;2,False,-1;  Direct;0.9,False,-1;  Ambient;0.1,False,-1;  Shadow;0.5,False,-1;Cast Shadows;1;  Use Shadow Threshold;0;Receive Shadows;1;GPU Instancing;1;LOD CrossFade;1;Built-in Fog;1;_FinalColorxAlpha;0;Meta Pass;1;Override Baked GI;0;Extra Pre Pass;0;DOTS Instancing;0;Tessellation;0;  Phong;0;  Strength;0.5,False,-1;  Type;0;  Tess;16,False,-1;  Min;10,False,-1;  Max;25,False,-1;  Edge Length;16,False,-1;  Max Displacement;25,False,-1;Write Depth;0;  Early Z;0;Vertex Position,InvertActionOnDeselection;1;0;8;False;True;True;True;True;True;True;True;False;;False;0
...
WireConnection;7;1;164;0
WireConnection;28;0;40;0
WireConnection;4;0;2;0
WireConnection;36;0;38;0
WireConnection;169;0;7;0
WireConnection;74;0;77;0
WireConnection;74;1;73;0
WireConnection;5;0;169;0
WireConnection;5;1;4;0
WireConnection;75;0;74;0
WireConnection;35;0;36;0
WireConnection;32;0;28;0
WireConnection;21;0;169;0
...
WireConnection;152;0;113;0
ASEEND*/
//CHKSM=B01A2D1550437E5DF7C8D9C1ADF4133EBFEF2D62